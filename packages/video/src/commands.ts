...
export const KEYFRAME_IMAGES = (memfsFilename: string, outDir: string, height = 69) =>
  `-skip_frame nokey -i ${memfsFilename} -vf scale=-1:${height} -vsync 0 -r 1000 -frame_pts 1 ${outDir}%09d.png`.split(
    " "
  )
