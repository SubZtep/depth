...
*/
  ...
  function G(a, c) {
    if (c)
      a: {
        ...
        c != d &&
          null != c &&
          C(b, a, { configurable: !0, writable: !0, value: c });
      }
  }
  G("Symbol", function (a) {
    function c(h) {
      if (this instanceof c) throw new TypeError("Symbol is not a constructor");
      return new b(d + (h || "") + "_" + g++, h);
    }
    function b(h, e) {
      this.g = h;
      C(this, "description", { configurable: !0, writable: !0, value: e });
    }
    if (a) return a;
  ...
  function ma(a) {
    this.next = function (c) {
      R(a.g);
      a.g.i ? (c = U(a, a.g.i.next, c, a.g.o)) : (a.g.o(c), (c = V(a)));
      return c;
    };
    this.throw = function (c) {
      R(a.g);
      a.g.i ? (c = U(a, a.g.i["throw"], c, a.g.o)) : (S(a.g, c), (c = V(a)));
      return c;
    };
  ...
  G("Promise", function (a) {
    ...
    c.prototype.B = function (e) {
      ...
      else if (e instanceof c) this.D(e);
      else {
        a: switch (typeof e) {
          case "object":
            var f = null != e;
    ...
    c.prototype.A = function (e) {
      ...
      "function" == typeof f ? this.F(f, e) : this.m(e);
    };
    ...
    c.prototype.v = function () {
      ...
      "function" === typeof e
        ...
        : ((e = D.document.createEvent("CustomEvent")),
    ...
    c.resolve = d;
    c.reject = function (e) {
      return new c(function (f, k) {
        k(e);
      });
    };
    c.race = function (e) {
      return new c(function (f, k) {
        for (var m = I(e), n = m.next(); !n.done; n = m.next())
          d(n.value).I(f, k);
      });
    };
    c.all = function (e) {
  ...
  G("Array.prototype.keys", function (a) {
    return a
      ? a
      : function () {
  ...
  function wa(a, c) {
    ...
    if (void 0 === a.m) {
      ...
      if (!b.getProgramParameter(h, b.LINK_STATUS))
        throw Error(
          "Could not compile WebGL program.\n\n" + b.getProgramInfoLog(h)
        );
      d = a.m = h;
      b.useProgram(d);
      g = b.getUniformLocation(d, "sampler0");
      a.i = {
        H: b.getAttribLocation(d, "aVertex"),
        G: b.getAttribLocation(d, "aTex"),
        V: g,
      };
      a.s = b.createBuffer();
      b.bindBuffer(b.ARRAY_BUFFER, a.s);
      b.enableVertexAttribArray(a.i.H);
      b.vertexAttribPointer(a.i.H, 2, b.FLOAT, !1, 0, 0);
      b.bufferData(
        b.ARRAY_BUFFER,
      ...
      b.enableVertexAttribArray(a.i.G);
      b.vertexAttribPointer(a.i.G, 2, b.FLOAT, !1, 0, 0);
      b.bufferData(
        b.ARRAY_BUFFER,
    ...
    b.enableVertexAttribArray(d.H);
    b.bindBuffer(b.ARRAY_BUFFER, a.s);
    b.vertexAttribPointer(d.H, 2, b.FLOAT, !1, 0, 0);
    b.enableVertexAttribArray(d.G);
    b.bindBuffer(b.ARRAY_BUFFER, a.o);
    b.vertexAttribPointer(d.G, 2, b.FLOAT, !1, 0, 0);
    b.bindFramebuffer(
      b.DRAW_FRAMEBUFFER ? b.DRAW_FRAMEBUFFER : b.FRAMEBUFFER,
      null
    );
    ...
    b.disableVertexAttribArray(d.H);
    b.disableVertexAttribArray(d.G);
    b.bindBuffer(b.ARRAY_BUFFER, null);
    a.h.bindTexture2d(0);
  }
  function xa(a) {
  ...
  function Ea() {
    return Y(this, function c() {
      return W(c, function (b) {
        switch (b.g) {
          case 1:
            return (b.m = 2), T(b, WebAssembly.instantiate(ya), 4);
          case 4:
            b.g = 3;
            b.m = 0;
            break;
  ...
  function Fa(a) {
    ...
    this.m = {};
    this.s = {};
    this.v = this.o = this.O = !0;
    this.F = Promise.resolve();
    this.N = "";
    this.u = {};
    this.locateFile = (a && a.locateFile) || za;
      ...
      return W(b, function (l) {
        switch (l.g) {
          ...
          case 2:
            ...
            if ("object" === typeof window)
              return (
                Aa("createMediapipeSolutionsWasm", {
                  locateFile: d.locateFile,
                }),
                Aa("createMediapipeSolutionsPackedAssets", {
                  locateFile: d.locateFile,
                }),
                (m = h.filter(function (q) {
                  return void 0 !== q.data;
                })),
                ...
                (r = Promise.all(
                  n.map(function (q) {
                    return void 0 === q.simd || (q.simd && e) || (!q.simd && !e)
                      ? Ba(g.locateFile(q.url, g.P))
                      : Promise.resolve();
                  })
                ).then(function () {
                  return Y(g, function v() {
                    var w,
                      y,
                      z = this;
                    return W(v, function (A) {
                      if (1 == A.g)
                        return (
                          ...
                          (y = window.createMediapipeSolutionsPackedAssets),
                          T(A, w(y), 2)
                        );
                      z.h = A.h;
                      A.g = 0;
                ...
                (p = (function () {
                  return Y(g, function v() {
                    var w = this;
                    return W(v, function (y) {
                      w.g.graph && w.g.graph.url
                        ? (y = T(y, Z(w, w.g.graph.url), 0))
                        : ((y.g = 0), (y = void 0));
                      return y;
                    });
                  });
                })()),
                T(l, Promise.all([r, t, p]), 7)
              );
            ...
            f = h
              ...
              .map(function (q) {
                return g.locateFile(q.url, g.P);
              });
            importScripts.apply(null, fa(f));
            return T(l, createMediapipeSolutionsWasm(Module), 6);
          case 6:
            d.h = l.h;
            d.j = new OffscreenCanvas(1, 1);
            d.h.canvas = d.j;
            k = d.h.GL.createContext(d.j, {
              antialias: !1,
              alpha: !1,
              U: "undefined" !== typeof WebGL2RenderingContext ? 2 : 1,
            });
            d.h.GL.makeContextCurrent(k);
            l.g = 4;
            break;
          case 7:
            d.j = document.createElement("canvas");
            u = d.j.getContext("webgl2", {});
            if (!u && ((u = d.j.getContext("webgl", {})), !u))
              return (
                alert(
            ...
            d.A = u;
            d.h.canvas = d.j;
            d.h.createContext(d.j, !0, !0, {});
          case 4:
            (d.i = new d.h.SolutionWasm()), (d.O = !1), (l.g = 0);
        }
      });
    });
  }
  function Ia(a) {
    return Y(a, function b() {
      var d = this,
        ...
        n,
        t;
      return W(b, function (r) {
        if (1 == r.g) {
          if (d.g.graph && d.g.graph.url && d.N === d.g.graph.url)
            return r.return();
          d.o = !0;
          ...
          d.N = d.g.graph.url;
          return T(r, Z(d, d.g.graph.url), 3);
        }
        2 != r.g && ((g = r.h), d.i.loadGraph(g));
        h = I(Object.keys(d.u));
        for (e = h.next(); !e.done; e = h.next())
          (f = e.value), d.i.overrideFile(f, d.u[f]);
        d.u = {};
        if (d.g.listeners)
          for (k = I(d.g.listeners), m = k.next(); !m.done; m = k.next())
            (n = m.value), Ja(d, n);
        t = d.l;
        d.l = {};
        d.setOptions(t);
  ...
  B.setOptions = function (a) {
    ...
    if (this.g.options) {
      for (
        var b = [], d = [], g = {}, h = I(Object.keys(a)), e = h.next();
        !e.done;
        g = { J: g.J, K: g.K }, e = h.next()
      ) {
        var f = e.value;
        !(f in this.l && this.l[f] === a[f]) &&
          ((this.l[f] = a[f]), (e = this.g.options[f])) &&
          (e.onChange &&
            ((g.J = e.onChange),
            (g.K = a[f]),
            b.push(
              (function (k) {
                return function () {
                  return Y(c, function n() {
                    var t,
                      r = this;
                    return W(n, function (p) {
                      if (1 == p.g) return T(p, k.J(k.K), 2);
                      t = p.h;
                      !0 === t && (r.o = !0);
                      p.g = 0;
                    });
      ...
      if (0 !== b.length || 0 !== d.length)
        (this.o = !0), (this.C = d), (this.D = b);
    }
  };
  function Ka(a) {
    return Y(a, function b() {
      var d = this,
        ...
        m,
        n;
      return W(b, function (t) {
        switch (t.g) {
          case 1:
            if (!d.o) return t.return();
            if (!d.D) {
              t.g = 2;
              break;
            }
          ...
          case 2:
            if (d.C) {
              f = new d.h.GraphOptionChangeRequestList();
              k = I(d.C);
              for (m = k.next(); !m.done; m = k.next())
                (n = m.value), f.push_back(n);
              d.i.changeOptions(f);
              f.delete();
              d.C = void 0;
            }
  ...
  function Z(a, c) {
    return Y(a, function d() {
      ...
      return W(d, function (f) {
        if (c in g.B) return f.return(g.B[c]);
        h = g.locateFile(c, "");
  ...
  B.overrideFile = function (a, c) {
    this.i ? this.i.overrideFile(a, c) : (this.u[a] = c);
  };
  B.clearOverriddenFiles = function () {
    this.u = {};
  ...
  B.send = function (a, c) {
    return Y(this, function d() {
      var g = this,
        ...
        r,
        p;
      return W(d, function (u) {
        if (1 == u.g) {
          if (!g.g.inputs) return u.return();
          h = 1e3 * (void 0 === c || null === c ? performance.now() : c);
          return T(u, g.F, 2);
        }
        if (3 != u.g) return T(u, g.initialize(), 3);
        e = new g.h.PacketDataList();
        f = I(Object.keys(a));
        for (k = f.next(); !k.done; k = f.next())
          if (((m = k.value), (n = g.g.inputs[m]))) {
            a: {
              var l = g;
              var q = a[m];
              switch (n.type) {
                case "video":
                  var v = l.m[n.stream];
                  v || ((v = new ua(l.h, l.A, l.v)), (l.m[n.stream] = v));
                  l = v;
                  0 === l.l && (l.l = l.h.createTexture());
                  if (
                    ...
                    q instanceof HTMLImageElement
                      ? ((w = q.naturalWidth), (v = q.naturalHeight))
                      : ((w = q.width), (v = q.height));
                  v = { glName: l.l, width: w, height: v };
                  w = l.g;
                  w.canvas.width = v.width;
                  w.canvas.height = v.height;
                  w.activeTexture(w.TEXTURE0);
                  l.h.bindTexture2d(l.l);
                  w.texImage2D(
                    w.TEXTURE_2D,
                    0,
                    w.RGBA,
                ...
                case "detections":
                  v = l.m[n.stream];
                  v || ((v = new xa(l.h)), (l.m[n.stream] = v));
                  l = v;
                  l.data || (l.data = new l.g.DetectionListData());
                  l.data.reset(q.length);
                  for (v = 0; v < q.length; ++v) {
                    w = q[v];
                    l.data.setBoundingBox(v, w.R);
                    if (w.M)
                      for (var y = 0; y < w.M.length; ++y) {
                        var z = w.M[y],
                          A = z.visibility ? !0 : !1;
                        l.data.addNormalizedLandmark(
                          v,
                          Object.assign(Object.assign({}, z), {
                            hasVisibility: A,
                            visibility: A ? z.visibility : 0,
                          })
                        );
                      }
                    if (w.L)
                      for (y = 0; y < w.L.length; ++y) {
                        z = w.L[y];
                        A = z.index ? !0 : !1;
                        var O = z.label ? !0 : !1,
                          M = z.displayName ? !0 : !1;
                        l.data.addClassification(v, {
                          score: z.score,
                          hasIndex: A,
                          index: A ? z.index : -1,
                          hasLabel: O,
  ...
  function La(a, c, b) {
    return Y(a, function g() {
      var h,
        ...
        M,
        pa;
      return W(g, function (E) {
        switch (E.g) {
          case 1:
            if (!b) return E.return(c);
            h = {};
            e = 0;
            f = I(Object.keys(b));
            for (k = f.next(); !k.done; k = f.next())
              (m = k.value),
                (n = b[m]),
                "string" !== typeof n && "texture" === n.type && ++e;
            1 < e && (t.v = !1);
            r = I(Object.keys(b));
            k = r.next();
          case 2:
            ...
            u = b[p];
            if ("string" === typeof u)
              return (M = h), (pa = p), T(E, Ma(t, p, c[u]), 15);
            l = c[u.stream];
            if (void 0 === l) {
              E.g = 3;
              break;
            }
            if ("detection_list" === u.type) {
              var x = l.getRectList(),
                J = l.getLandmarksList(),
                F = l.getClassificationsList(),
                H = [];
              if (x)
                for (var N = 0; N < x.size(); ++N) {
                  var da = { R: x.get(N), M: Ca(J.get(N)), L: Da(F.get(N)) };
                  H.push(da);
                }
              h[p] = H;
              E.g = 7;
            ...
            if ("landmarks_list" === u.type) {
              if ((v = l.getLandmarksList()))
                for (x = [], J = v.size(), F = 0; F < J; ++F)
                  (H = v.get(F)), x.push(Ca(H)), H.delete();
              else x = void 0;
              h[p] = x;
              E.g = 7;
              break;
            ...
            if ("classifications_list" === u.type) {
              if ((y = l.getClassificationsList()))
                for (x = [], J = y.size(), F = 0; F < J; ++F)
                  (H = y.get(F)), x.push(Da(H));
              else x = void 0;
              h[p] = x;
              E.g = 7;
              break;
            }
            if ("object_detection_list" === u.type) {
              if ((z = l.getObjectDetectionList()))
                for (x = [], J = z.size(), F = 0; F < J; ++F) {
                  H = z.get(F);
                  N = x;
                  da = N.push;
                  for (
            ...
            if ("texture" !== u.type)
              throw Error("Unknown output config type: '" + u.type + "'");
            A = t.s[p];
            A || ((A = new ua(t.h, t.A, t.v)), (t.s[p] = A));
            x = A;
            J = l.getTexture2d();
            wa(x, J);
            x = va(x);
          ...
          case 14:
            (O = E.h), (h[p] = O);
          case 7:
            u.transform && h[p] && (h[p] = u.transform(h[p]));
            E.g = 3;
            break;
          case 15:
            M[pa] = E.h;
  ...
  function Ma(a, c, b) {
    return Y(a, function g() {
      ...
      return W(g, function (f) {
        ...
        if (b.isClassificationsList())
          return f.return(b.getClassificationsList());
        if (b.isObjectDetectionList())
          return f.return(b.getObjectDetectionList());
        if (b.isTexture2d()) {
          e = h.s[c];
          e || ((e = new ua(h.h, h.A, h.v)), (h.s[c] = e));
          var k = f.return;
          var m = e;
          var n = b.getTexture2d();
          wa(m, n);
          m = va(m);
          return k.call(f, m);
        }
  ...
  function Ja(a, c) {
      ...
      onResults: function (f) {
        return Y(a, function m() {
          ...
          return W(m, function (q) {
            t = n;
            r = {};
            for (p = 0; p < c.wants.length; ++p) r[d[p]] = f.get(p);
            u = La(n, r, c.outs);
            if ((l = n.listeners[b]))
              return q.return(
                n.F.then(function () {
                  ...
                  return Y(t, function y() {
                    var z,
                      A,
                      O = this;
                    return W(y, function (M) {
                      z = l(v);
                      for (A = 0; A < c.wants.length; ++A) r[d[A]].delete();
                      if (z) return (O.F = z), M.return(z);
                      M.g = 0;
                    });
                  });
                })
    ...
    a.i.attachMultiListener(g, h);
    g.delete();
  }
  B.onResults = function (a, c) {
    this.listeners[c || "$"] = a;
  };
  X("Solution", Fa);
    ...
    this.g = new Fa({
      ...
      files: function (b) {
        return [
          ...
          { data: !0, url: Na(b.modelComplexity) },
        ];
      },
      graph: { url: "pose_web.binarypb" },
      listeners: [
        {
          wants: ["pose_landmarks", "world_landmarks", "image_transformed"],
          outs: {
            image: "image_transformed",
            poseLandmarks: { type: "landmarks", stream: "pose_landmarks" },
            poseWorldLandmarks: {
              type: "landmarks",
      ...
      options: {
          ...
          onChange: function (b) {
            return Y(c, function g() {
              var h,
                ...
                f = this,
                k;
              return W(g, function (m) {
                if (1 == m.g)
                  return (
                    (h = Na(b)),
                    (e = "third_party/mediapipe/modules/pose_landmark/" + h),
                    // (e = "" + h),
                    T(m, Z(f.g, h), 2)
                  );
                k = m.h;
                f.g.overrideFile(e, k);
                return m.return(!0);
              });
            });
          },
        ...
        minTrackingConfidence: {
          ...
          graphOptionXref: {
            ...
            calculatorName:
              "poselandmarkgpu__poselandmarkbyroigpu__poselandmarkbyroipostprocessing__ThresholdingCalculator",
            fieldName: "threshold",
          },
        },
      },
  ...
  B.send = function (a, c) {
    return Y(this, function d() {
      var g = this;
      return W(d, function (h) {
        return T(h, g.g.send(a, c), 0);
      });
    });
  };
  B.setOptions = function (a) {
  ...
  X("POSE_LANDMARKS_NEUTRAL", { NOSE: 0 });
}.call(this));
